...
/***/function (module, exports) {
	...
	function getZoneColor(cell, real) {
		switch (cell) {
			...
			case 'nest':
				...
				return real ? color.green : color.lavender;
			default:
				return real ? color.lgreen : color.lgrey;
		}
	}
	...
	var _gui = {
		getStatNames: function getStatNames(num) {
			switch (num) {
				case 1:
					return ['Body Damage', 'Max Health', 'Bullet Speed', 'Bullet Range', 'Armor Penetration', 'Bullet Damage', 'Engine Acceleration', 'Movement Speed', 'Health Regeneration', 'Resistance'];
				case 2:
				...
				case 4:
					return ['Body Damage', 'Max Health', 'Swarm Speed', 'Swarm Health', 'Swarm Penetration', 'Swarm Damage', 'Reload', 'Armor Lightness', 'Armor Regeneration', 'Armor Strength'];
				case 5:
				...
				default:
					return ['Armor Level', 'Armor Thickness', 'Bullet Speed', 'Bullet Range', 'Armor Penetration', 'Bullet Damage', 'Reload Time', 'Armor Lightness', 'Armor Regeneration', 'Armor Strength'];
			}
		},
		skills: [{
			amount: 0,
	...
	// Window setup <3
	console.log('You are connected to US EAST VIRGINIA 54.240.229.145');
	console.log('Your mother is a homosexual');
	global.mobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent);
	var serverName = 'US East Virginia';
	var serverName2 = '54.240.229.145';
	...
	var drawEntity = function () {
		...
		return function (x, y, instance, ratio) {
			...
			setColor(context, mixColors(color.guiblack, render.status.getColor(), render.status.getBlend()));
	...
	var gameDrawDead = function () {
		...
		return function () {
			...
			text.playagain.draw('Press enter to respawn!', x, y + 125, 16, color.guiwhite, 'center');
		};
	}();
